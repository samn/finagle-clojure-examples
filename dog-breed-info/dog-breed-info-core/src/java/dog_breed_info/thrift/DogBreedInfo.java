...
public class DogBreedInfo {
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void isBreedBeautiful(Request request, AsyncMethodCallback<isBreedBeautiful_call> __resultHandler__) throws TException {
      checkReady();
      isBreedBeautiful_call __method_call__ = new isBreedBeautiful_call(request, __resultHandler__, this, super.protocolFactory, super.transport);
    ...
    public static class isBreedBeautiful_call extends TAsyncMethodCall {
      ...
      public isBreedBeautiful_call(Request request, AsyncMethodCallback<isBreedBeautiful_call> __resultHandler__, TAsyncClient __client__, TProtocolFactory __protocolFactory__, TNonblockingTransport __transport__) throws TException {
      ...
      public Response getResult() throws TException {
        ...
        return (new Client(__prot__)).recv_isBreedBeautiful();
      }
     }
   }
        ...
        Function<byte[], com.twitter.util.Try<Response>> replyDeserializer =
          new Function<byte[], com.twitter.util.Try<Response>>() {
            public com.twitter.util.Try<Response> apply(byte[] __buffer__) {
              ...
              try {
                return new com.twitter.util.Return(((new Client(__prot__)).recv_isBreedBeautiful()));
              } catch (Exception e) {
